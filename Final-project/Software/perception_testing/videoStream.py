...
def main():
    # Write your primary program logic here
    ip_address="192.168.1.5"
    port="8081"
    username="admin"
    password="admin"
    camera=cameraStream(username,password,ip_address, port)

    duration = 60 # Time to run in seconds
    ...
    while True:
        ...
        print(f"obstacle_detected: {detector.detect_red_obj(frame)} ,obstacle position:{detector.obstacle_direction(frame)} ,obstacle distance: {detector.obstacle_distance(frame)}")
